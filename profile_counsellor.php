...
<div id="band" class="container text-left">
  ...
  <div class="row">
    <div class="col-md-12">
      <h2>USER ADDRESS:      <?php echo $row["address"]; ?></h2>
...
</p><a href='link_counselling.php?id=$id' download='<?php echo $row["txtNameVIC"]; ?>.txt'>Download Details</a>
</p><a href='link_counselling.php?id=$id'>View All Details</a>
</div>                                        
